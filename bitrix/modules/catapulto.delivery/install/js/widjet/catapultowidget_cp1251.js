...
(function() {
    ...
    class Assets {
        constructor(lang = 'ru') {
            ...
            self.ru = {
                ui_text: {
                    ...
                    base_delivery_variant_day: [' ????', ' ???', ' ????'],
                    filter_variant_day: ['?? #TIME#-?? ???', '?? #TIME#-? ????', '?? #TIME#-? ????'],
                    delivery_variant_price_from: '?? ',
                    base_search_title: '??????? ??? ?????????????? ??? ??????? ????????',
                    base_search_label: '??????? ????? ??? ?????? ?????',
                    base_search_description: '???? ??? ????????? ???????? ????????, ???????, ' +
                        '??????????, ??? ?????? ????? ??? ????? ??????? ???????',
                    map_search_placeholder: '??????? ?????',
                    base_search_submit_text: '?????',
                    delivery_variant_container_title: '???????? ?????? ????????',
                    delivery_variant_courier_title: '?????? ?? ?????',
                    delivery_variant_pvz_title: '????? ?????? ???????',
                    delivery_variant_filter_speed: '?? ????????',
                    delivery_variant_filter_rate: '?? ????????',
                    delivery_variant_filter_price: '?? ?????????',
                    panel_pvz_list_title: '?????? ?????? (#COUNT# ??.)',
                    panel_filter_list_title: '?????????? ????????',
                    map_selector_courier: '????????',
                    map_selector_pvz: '????? ??????',
                    panel_info_pvz: '??????',
                    panel_info_type_1: '????????',
                    panel_info_type_2: '???',
                    ...
                    panel_info_pay_cash: '?????? ?????????',
                    panel_info_pay_card: '?????? ??????',
                    panel_info_placeholder_all: '??? ? ?????????',
                    panel_info_placeholder_pvz: '?????? ???',
                    panel_info_placeholder_terminal: '?????? ?????????',
                    panel_info_filter: '????? ?????????? ????????',
                    map_search_button: '?????',
                    delivery_variant_item_time_title: '????',
                    delivery_variant_item_time_title_date: '????',
                    variant_day_date: '? ',
                    load_spinner_text: '???????? ???????????',
                    pvz_item_time: '<span>????: </span>#time#',
                    count_template: ' (#COUNT# ??.)',
                    detail_price_title: '????????? ????????:',
                    detail_address_title: '????? ?????? ?????? ???????:',
                    detail_work_title: '????? ??????:',
                    detail_phone_title: '????????:',
                    detail_how_to_find_title: '??? ? ??? ????????:',
                    detail_select: '???????',
                    courier_variant_in_time_template: '#PERCENT#% ? ????',
                    modal_title: '???????? ???? ? ????? ?????????',
                    refresh_btn_text: '?????????????',
                    api_error_text: '? ?????????, ?? ??????? ???????? ?????? ?? ????????',
                    api_error_text_r400: 'Bad Request (?????? 400)',
                    api_error_text_r401: '?????? ????? ???????',
                    api_error_text_r403: '403 Forbidden',
                    api_error_text_r404: '?????????? ?? ?????? (?????? 404)',
                    api_error_text_r500: '????????? ?????????? ?????? ???????',
        ...
        getDeliveryDateMonthDay = (date, addFrom = true) => {
            ...
            // ???????? ????? "????"
            const dayWord = this.wordByNumber(diffDays, [' ????', ' ???', ' ????']);
            
            // ????????? ???????? ??????
            return `? ??????? ???? ${currentDateFormatted} ${diffDays}${dayWord}, ?? ???? ${deliveryDateFormatted}`;
        }
    ...
    window.CatapultoWidget = class CatapultoWidget {
        ...
        getShortDataForItem = (item) => {
            ...
            if (item.getData().variant) {
                ...
                price = '????????? : ' + this.getAssets().getDeliveryVariantItemPrice(item.getData().variant.price);
            ...
            if (item.getData().Terminal) {
                address = '?????: ' + item.getData().Terminal.address;
            }
            if (date) {
