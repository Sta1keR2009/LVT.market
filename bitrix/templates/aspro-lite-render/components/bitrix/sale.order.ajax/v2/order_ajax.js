  ...
  BX.Sale.OrderAjaxComponent = {
          ...
          if (this.result.PERSON_TYPE.hasOwnProperty(i)) {
            ...
            node.appendChild(
              BX.create("DIV", {
                props: {
                  className:
                    "person-type chip bg-theme-active color-theme-hover-no-active" +
                    (currentType.CHECKED == "Y" ? " active" : ""),
                },
                children: [label],
              })
            );
    ...
    editPaySystemItems: function (paySystemNode) {
      ...
      var paySystemItemsContainer = BX.create("DIV", {
          props: { className: "bx-soa-pp-item-container grid-list grid-list--gap-20" },
        }),
        paySystemItemNode,
        i;
    ...
    editActiveDeliveryBlock: function (activeNodeMode) {
      ...
      if (this.initialized.delivery) {
        ...
        deliveryNode = BX.create("DIV", {
          props: { className: "bx-soa-pp grid-list grid-list--items-1 grid-list--gap-20" },
        });
          ...
          const $price = BX.create("div", {
            ...
            html: this.getDerivedBlock(
              ...
              currentDelivery["PRICE"] > 0
                ...
                : this.params.MESS_PRICE_FREE || BX.message("PRICE_FREE_DEFAULT")
            ),
          });
    ...
    editDeliveryItems: function (deliveryNode) {
      ...
      var deliveryItemsContainer = BX.create("DIV", {
          props: { className: "bx-soa-pp-item-container grid-list__item grid-list grid-list--gap-20" },
        }),
        deliveryItemNode,
        k;
    ...
    editDeliveryInfo: function (deliveryNode) {
      ...
      if (extraServices.length) {
        ...
        deliveryNode.appendChild(
          BX.create("DIV", {
            props: { className: "bx-soa-extraservices grid-list__item grid-list" },
    ...
    showInfoFromProps: function (node) {
      ...
      node.appendChild(
        BX.create("div", {
          ...
          children: [
            BX.create("div", {
              props: { className: "col-sm-12 bx-soa-pp-item-container grid-list grid-list--gap-20" },
              children: content,
            }),
            newProfile,
            profileChangeInput,
    ...
    editPropsMap: function (propsNode) {
      var propsMapContainer = BX.create("DIV", {
          props: { className: "grid-list__item" },
      ...
      if (!this.result.SHOW_AUTH) {
        ...
        this.totalInfoBlockNode.appendChild(
          BX.create("DIV", {
            props: {
              className:
                "bx-soa-cart-total-button-container mt mt--24 lic_condition" + (!showOrderButton ? " visible-xs" : ""),
            },
            children: [
              BX.create("A", {
                props: {
        ...
        if (!this.licensesConditions.length) {
          if (arAsproOptions["THEME"]["SHOW_LICENCE"] == "Y") {
            this.licensesConditions.push(
              createCheckboxContainer({
                name: "licenses_order",
                error: BX.message("JS_REQUIRED_LICENSES"),
                text: BX.message("LICENSES_TEXT"),
                checked: arAsproOptions["THEME"]["LICENCE_CHECKED"] == "Y",
              })
            );
          }
          if (arAsproOptions["THEME"]["SHOW_OFFER"] == "Y") {
            this.licensesConditions.push(
              createCheckboxContainer({
                name: "offer_order",
                error: BX.message("JS_REQUIRED_OFFER"),
                text: BX.message("OFFER_TEXT"),
                checked: arAsproOptions["THEME"]["OFFER_CHECKED"] == "Y",
              })
            );
          }
        }
