            ...
            <div class="auth form-block">
                <div class="form <?= $arParams['POPUP_AUTH'] === 'Y' ? 'popup' : ''; ?> <?= $arResult['SHOW_SMS_FIELD'] ? 'form--send-sms' : ''; ?>">
                    ...
                    <form id="auth-page-form<?=$rand; ?>" name="system_auth_form<?=$arResult['RND']; ?>" method="post" target="_top" action="<?=$arParams['AUTH_URL']; ?>?login=yes">
                        ...
                        <input type="hidden" name="SOLUTION_ID" value="<?=LITE_MODULE_ID;?>" />
                        ...
                        <div class="form-footer auth__bottom <?= $arResult['SHOW_SMS_FIELD'] ? 'hidden' : ''; ?>">
                            ...
                            $isLicenseAsCheckbox = TSolution::GetFrontParametrValue('LICENCE_AS_CHECKBOX') == "Y";
                            $isShowLicensesAsCheckBox = $isShowLicenses && $isLicenseAsCheckbox;
                            $isShowLicensesAsText = $isShowLicenses && !$isLicenseAsCheckbox;
                            ?>

                            <?if($isShowLicensesAsCheckBox):?>
                                <div class="form-checkbox mb mb--24 relative">
                                    <label for="licenses_auth<?=$rand; ?>" class="form-checkbox__label">
                                    ...
                                    <input class="form-checkbox__input form-checkbox__input--visible" type="checkbox" id="licenses_auth<?=$rand; ?>" <?=TSolution::GetFrontParametrValue('LICENCE_CHECKED') === 'Y' ? 'checked' : '';?> name="licenses_popup" required value="Y">
                                </div>
                            <?endif;?>
                            ...
                            <?endif; ?>
                            <?if($isShowLicensesAsText):?>
                                <div class="licence_block">
                                    <label for="licenses_auth">
                                        <span><?include str_replace('//', '/', $_SERVER['DOCUMENT_ROOT'].SITE_DIR.'include/licenses_text.php'); ?></span>
                                    </label>
                                    <input type="checkbox" id="licenses_auth" name="licenses_popup" checked required value="Y" class="form-checkbox__input">
                                </div>
                            <?endif; ?>
                        </div>
                    </form>
