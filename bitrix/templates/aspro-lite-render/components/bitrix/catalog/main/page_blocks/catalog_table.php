...
$arParams['LINE_ELEMENT_COUNT'] = $countElementsInRow ?: $arParams['LINE_ELEMENT_COUNT'];
$linerow = match (strval($arParams['LINE_ELEMENT_COUNT'])) {
...
<?$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'MARK_UNAVAILABLE_IN_REGION' => $arParams['MARK_UNAVAILABLE_IN_REGION'],
        'TYPE_SKU' => $arTheme['CATALOG_PAGE_DETAIL_SKU']['VALUE'],
        'SET_SKU_TITLE' => ((TSolution::GetFrontParametrValue('CATALOG_PAGE_DETAIL_SKU') === 'TYPE_1' && TSolution::GetFrontParametrValue('CHANGE_TITLE_ITEM_LIST') === 'Y') ? 'Y' : ''),
        ...
        'SHOW_BASKET_COUNTER' => TSolution::GetFrontParametrValue('USE_PRODUCT_QUANTITY_LIST') == 'Y',
