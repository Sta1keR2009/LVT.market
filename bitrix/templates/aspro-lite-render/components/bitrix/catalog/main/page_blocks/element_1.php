<?$APPLICATION->IncludeComponent(
    ...
    [
        ...
        // Кеш catalog.element сохранял пустую разметку карточки (остался только epilog с описанием).
        'CACHE_TYPE' => 'N',
        ...
        'TYPE_SKU' => $typeSKU,
        'SET_SKU_TITLE' => ((($typeSKU == 'TYPE_1' || TSolution::GetFrontParametrValue('CATALOG_PAGE_DETAIL_SKU') === 'TYPE_1') && TSolution::GetFrontParametrValue('CHANGE_TITLE_ITEM_DETAIL') === 'Y') ? 'Y' : ''),
        'OID' => $arParams['OID'],
        ...
        'T_DESC' => ($arParams['T_DESC'] ?: GetMessage('T_DESC')),
        'T_CHAR' => ($arParams['T_CHAR'] ?: GetMessage('T_CHARACTERISTICS')),
        'T_DOCS' => ($arParams['T_DOCS'] ?: GetMessage('T_DOCS')),
        'T_REVIEWS' => ($arParams['T_REVIEWS'] ?: GetMessage('T_REVIEWS')),
        'T_SALE' => ($arParams['T_SALE'] ?: GetMessage('T_SALE')),
        'T_SERVICES' => ($arParams['T_SERVICES'] ?: GetMessage('T_SERVICES')),
        'T_ARTICLES' => ($arParams['T_ARTICLES'] ?: GetMessage('T_ARTICLES')),
        'T_VIDEO' => ($arParams['T_VIDEO'] ?: GetMessage('T_VIDEO')),
        'T_GOODS' => ($arParams['T_GOODS'] ?: GetMessage('T_GOODS')),
        'T_ASSOCIATED' => ($arParams['T_ASSOCIATED'] ?: GetMessage('T_ASSOCIATED')),
        'T_EXPANDABLES' => ($arParams['T_EXPANDABLES'] ?: GetMessage('T_EXPANDABLES')),
        'T_SKU' => ($arParams['T_SKU'] ?: GetMessage('T_SKU')),
        'T_COMPLECT' => ($arParams['T_COMPLECT'] ?: GetMessage('KOMPLECT_TITLE')),
        'T_FAQ' => ($arParams['T_FAQ'] ?: GetMessage('T_FAQ')),

        'SHOW_BUY' => $arParams['SHOW_BUY'],
        'T_BUY' => ($arParams['T_BUY'] ?: GetMessage('T_BUY')),
        'SHOW_DELIVERY' => $arParams['SHOW_DELIVERY'],
        'T_DELIVERY' => ($arParams['T_DELIVERY'] ?: GetMessage('T_DELIVERY')),
        'SHOW_PAYMENT' => $arParams['SHOW_PAYMENT'],
        'T_PAYMENT' => ($arParams['T_PAYMENT'] ?: GetMessage('T_PAYMENT')),
        'SHOW_DOPS' => $arParams['SHOW_DOPS'],
        'T_DOPS' => ($arParams['T_DOPS'] ?: GetMessage('T_DOPS')),
        ...
        'DETAIL_BLOG_EMAIL_NOTIFY' => ($arParams['DETAIL_BLOG_EMAIL_NOTIFY'] ?? 'Y'),
        ...
        'SHOW_BASIS_PRICE' => ($arParams['DETAIL_SHOW_BASIS_PRICE'] ?? 'Y'),
        ...
        'T_BIG_GALLERY' => ($arParams['T_BIG_GALLERY'] ?: GetMessage('T_BIG_GALLERY')),

        'LINKED_FILTER_BY_PROP' => $arAllValues,
        'LINKED_FILTER_BY_FILTER' => $arTab,
        'DETAIL_BLOCKS_ORDER' => ($arParams['DETAIL_BLOCKS_ORDER'] ?: 'sale,tabs,big_gallery,services,articles,licenses,goods,comments'),
        'DETAIL_BLOCKS_TAB_ORDER' => ($arParams['DETAIL_BLOCKS_TAB_ORDER'] ?: 'desc,char,docs,video,reviews,custom_tab'),
        'DETAIL_BLOCKS_ALL_ORDER' => ($arParams['DETAIL_BLOCKS_ALL_ORDER'] ?: 'sale,desc,char,reviews,big_gallery,video,services,articles,docs,licenses,goods,custom_tab,comments'),
        ...
        'STORES_FILTER' => ($arParams['STORES_FILTER'] ?: 'TITLE'),
        'STORES_FILTER_ORDER' => ($arParams['STORES_FILTER_ORDER'] ?: 'SORT_ASC'),
        ...
        'DETAIL_LINKED_TEMPLATE' => ($arParams['DETAIL_LINKED_TEMPLATE'] ?? 'linked'),
        ...
        'SHOW_BASKET_COUNTER' => TSolution::GetFrontParametrValue('USE_PRODUCT_QUANTITY_DETAIL') == 'Y',
    ],
    $component
);?>
