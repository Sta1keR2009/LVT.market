    ...
    checkMinPrice: function () {
      ...
      if (arAsproOptions["PRICES"]["MIN_PRICE"] && arAsproOptions["PRICES"]["MIN_PRICE"] > this.result.allSum) {
        ...
        if (typeof jsPriceFormat === "function" && jsPriceFormat) {
          var svgMinPrice =
            '<i class="svg inline  svg-inline-warning fill-theme-svg no-shrinked error_icon_basket" aria-hidden="true"><svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M13 23C13 21.3431 14.3431 20 16 20C17.6569 20 19 21.3431 19 23C19 24.6569 17.6569 26 16 26C14.3431 26 13 24.6569 13 23ZM16 22C15.4477 22 15 22.4477 15 23C15 23.5523 15.4477 24 16 24C16.5523 24 17 23.5523 17 23C17 22.4477 16.5523 22 16 22Z"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M17.5259 6.34091C16.5554 5.90459 15.4446 5.90459 14.4741 6.34091C12.951 7.02568 12.0706 8.64126 12.3208 10.2924L13.2866 16.6668C13.4899 18.0084 14.6431 19.0001 16 19.0001C17.3569 19.0001 18.5102 18.0084 18.7134 16.6668L19.6793 10.2924C19.9294 8.64125 19.049 7.02568 17.5259 6.34091ZM15.2942 8.16503C15.7431 7.96322 16.2569 7.96322 16.7058 8.16504C17.4103 8.48177 17.8175 9.22904 17.7018 9.99276L16.736 16.3672C16.6809 16.7311 16.3681 17.0001 16 17.0001C15.632 17.0001 15.3192 16.7311 15.264 16.3672L14.2982 9.99276C14.1825 9.22905 14.5897 8.48177 15.2942 8.16503Z"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M0 16C0 7.16344 7.16344 0 16 0C24.8366 0 32 7.16344 32 16C32 24.8366 24.8366 32 16 32C7.16344 32 0 24.8366 0 16ZM16 2C8.26801 2 2 8.26801 2 16C2 23.732 8.26801 30 16 30C23.732 30 30 23.732 30 16C30 8.26801 23.732 2 16 2Z"></path></svg></i>';
          $checkoutOrder.innerHTML =
            '<div class="icon_error_wrapper rounded-x flexbox flexbox--row flexbox--justify-beetwen flexbox--align-start colored_theme_bg_opacity"><div class="icon_error_block_basket font_13">' +
            ...
            $checkoutOrder.appendChild(
              BX.create({
                tag: 'div',
                props: {
                  className: "basket-checkout-block basket-checkout-btn checkout-order"
               },
                children: [
                   BX.create({
                      tag: 'a',
                      attrs: {
                        href: arAsproOptions.THEME.CATALOG_PAGE_URL,
                      },
                      children: [
                        BX.create("button", {
                          props: {
                            className: "btn btn-lg btn-default basket-btn-checkout has-ripple",
                          },
                          text: BX.message("SBB_CATALOG"),
                        })
                      ]
                   }),
                ]
