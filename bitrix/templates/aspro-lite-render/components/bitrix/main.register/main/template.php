                ...
                <form id="registraion-page-form" method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data" >
                    ...
                    <div class="form-body">
                        ...
                        <?if($isShowLicensesAsCheckBox):?>
                            <div class="form-checkbox mb mb--16 mt mt--24 relative">
                                <label for="licenses_register" class="form-checkbox__label">
                                ...
                                <input class="form-checkbox__input form-checkbox__input--visible" type="checkbox" id="licenses_register" <?=TSolution::GetFrontParametrValue('LICENCE_CHECKED') === 'Y' ? 'checked' : '';?> name="licenses_popup" required value="Y">
                            </div>
                        <?endif;?>
                    </div>
