...
<div class="search-page">
	<div class="searchinput">
		<form class="search " action="" method="get">
			...
			<?}else{?>
				<input class="q form-control search-input" type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" size="40" />
			<?}?>
		...
		<?}?>
			...
			<div class="search-button-div">
				...
				<button class="btn btn-search btn--no-rippple fill-dark-light-block banner-light-icon-fill light-opacity-hover" type="submit" name="s" value="<?=GetMessage("SEARCH_GO")?>">
