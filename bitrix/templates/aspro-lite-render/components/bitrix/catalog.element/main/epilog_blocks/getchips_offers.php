...
$lvtSupplierOffersTitle = (string)($lvtSupplierOffersTitle ?? ($lvtSupplierOffersInColumn ? 'Наличие и цены по складам:' : 'Наличие по складам'));
...
<link rel="stylesheet" href="/local/css/getchips_offers_card.css?v=23">
<link rel="stylesheet" href="/local/css/lvt_supplier_offers_responsive.css?v=9">
<script src="/local/js/lvt_supplier_offers_lazy.js?v=5"></script>
...
(function() {
    ...
    <div class="lvt-supplier-offers__loading" role="status" aria-live="polite">
        ...
        <span class="lvt-supplier-offers__muted">Загрузка наличия по складам...</span>
    </div>
