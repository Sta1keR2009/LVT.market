...
$headerInnerClasses = ' header__inner--no-pt';
if(!$bNarrowHeader) {
	$headerInnerClasses .= ' header__inner--paddings';
}

$topPartClasses = '';
//$topPartClasses .= ' header__top-part--short';
...
<header class="header_4 header <?=($arRegion ? 'header--with_regions' : '')?> <?=$bNarrowHeader ? 'header--narrow' : ''?> <?=TSolution::ShowPageProps('HEADER_COLOR')?>">
	<div class="header__inner <?=$headerInnerClasses?>">
			...
			<div class="header__main-inner <?=$innerClasses?>">
				...
				<div class="header__main-item">
					<div class="line-block line-block--40">
						<?//show logo?>
						<div class="logo <?=htmlspecialcharsbx($logoClass)?> line-block__item no-shrinked">
				...
				$blockOptions = array(
					...
					'AJAX_BLOCK' => $ajaxBlock,
					'VISIBLE' => $bShowSlogan,
					'WRAPPER' => 'header__main-item hide-1300',
				);
				?>
				<?=TSolution\Functions::showHeaderBlock($blockOptions);?>
		...
		<div class="header__bottom-part  <?=$bottomPartClasses?>">
			...
			<div class="header__bottom-inner relative <?=$bCatalogInBtn ? 'header__bottom-inner--long' : ''?>">
