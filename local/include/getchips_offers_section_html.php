...
function getchips_offers_section_html(array $ctx): string
{
    ...
    require_once $_SERVER['DOCUMENT_ROOT'] . '/local/include/lvt_getchips_price_header_html.php';
    $priceHeaderSwitchHtml = lvt_getchips_price_header_html($usdToRub, $rateDate !== '' ? $rateDate : date('d.m.Y'));
    ...
    <div class="detail-block ordered-block getchips-offers-section" data-page-catalog-element-id="<?= $pageCatalogElementId ?>"
        ...
        <?php if (!$skipHeading) { ?>
        <h3 class="getchips-offers__title">Наличие по складам</h3>
        <?php } ?>
        ...
        <div class="getchips-offers__table-wrap">
            <table class="getchips-offers__table js-getchips-offers-table<?= $offersCount > $visibleGetchipsRows ? ' getchips-offers__table--collapsible' : '' ?>" data-usd-to-rub="<?=htmlspecialchars((string)$usdToRub, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8')?>" data-display-currency="RUB">
                <thead>
                <tr>
                    <th>
        ...
        <?php if ($withAssets) { ?>
            <link rel="stylesheet" href="/local/css/getchips_offers_card.css?v=21">
            <script src="/local/js/getchips_offers_card.js?v=42" defer></script>
        <?php } ?>
    </div>
    <?php
...
function getchips_offers_table_shell_html(array $ctx): string
{
    ...
    return '<span class="hidden" data-bitrix-sessid="' . $sessIdEsc . '" aria-hidden="true"></span>'
        ...
        . $articleNote
        . '<div class="getchips-offers__table-wrap">'
        . '<table class="getchips-offers__table js-getchips-offers-table" data-usd-to-rub="' . htmlspecialchars((string) $usdToRub, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') . '" data-display-currency="RUB">'
        . '<thead><tr>'
