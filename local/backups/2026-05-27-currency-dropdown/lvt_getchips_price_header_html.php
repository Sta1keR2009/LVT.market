...
if (!function_exists('lvt_getchips_price_header_html')) {
    ...
    function lvt_getchips_price_header_html(float $usdToRub, string $rateDate = ''): string
    {
        ...
        return '<span class="getchips-price-head">'
            ...
            . '<button type="button" class="getchips-currency-switch__trigger" aria-haspopup="listbox" aria-expanded="false">'
            ...
            . '<span class="getchips-currency-alert js-getchips-usd-alert" data-notice="Курс ЦБ получен: ' . $rateDateEsc . '.">!</span>'
            . '</span>'
            . '</span>';
    }
}
